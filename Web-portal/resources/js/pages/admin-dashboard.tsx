...
const metrics = [
    ...
    { label: 'System Health', value: '99%', icon: Settings },
    { label: 'Total Products', value: '156', icon: LayoutGrid },
];
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <section className="rounded-xl border border-slate-100 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                            ...
                            <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                                <Link
                                    href={dashboard()}
                                    className="inline-flex items-center justify-center rounded-lg bg-slate-900 px-4 py-3 text-sm font-semibold text-white transition hover:bg-slate-800 dark:bg-slate-100 dark:text-slate-950 dark:hover:bg-slate-200"
                                >
                                    View All Users
                                </Link>
                                {[
